<h2><a href="https://leetcode.com/problems/zigzag-iterator/">281. Zigzag Iterator</a></h2><h3>Medium</h3><hr><div><p>Given two vectors of integers <code>v1</code> and <code>v2</code>, implement an iterator to return their elements alternately.</p>
