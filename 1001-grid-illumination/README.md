<h2><a href="https://leetcode.com/problems/grid-illumination/">1001. Grid Illumination</a></h2><h3>Hard</h3><hr><div><p>There is a 2D <code>grid</code> of size <code>n x n</code> where each cell of this grid has a lamp that is initially <strong>turned off</strong>.</p>
