<h2><a href="https://leetcode.com/problems/number-of-people-that-can-be-seen-in-a-grid/">2282. Number of People That Can Be Seen in a Grid</a></h2><h3>Medium</h3><hr><div><p>You are given an <code>m x n</code> <strong>0-indexed</strong> 2D array of positive integers <code>heights</code> where <code>heights[i][j]</code> is the height of the person standing at position <code>(i, j)</code>.</p>
...
<pre><strong>Input:</strong> heights = [[3,1,4,2,5]]
...
<pre><strong>Input:</strong> heights = [[5,1],[3,1],[4,1]]
